...
{
    [TestClass]
    public class BTA279_CSP_RequestCredit_Online_TransactionDate : ProjectTestBase
    {
        ...
        public void BTA_279_CSP_RequestCredit_Online_TransactionDate()
        {
            ...
            try
            {
                ...
                stepstatus = CSPortal_RequestCredit.Search_Online_BasedOnTransactionDate(RequestCredit_Search_Criteria.TransactionNumber, RequestCredit_Search_Criteria.TxnDate, out Step_Output);
                testStep.SetOutput(Step_Output);
                testStep = TestStepHelper.EndTestStep(testCase, testStep, stepName, stepstatus, DriverContext.SendScreenshotImageContent("WEB"));
                listOfTestSteps.Add(testStep);
                #endregion
