namespace BnPBaseFramework.Web
{
    ...
    public class DriverContext
    {
        ...
        /// <summary>
        /// Gets or sets extenttest.
        /// </summary>
        /// <value>
        /// extenttest
        /// </value>
        public ExtentTest Etest { get; set; }
        ...
        private FirefoxOptions FirefoxOptions
        {
            get
            {
                ...
                options.SetPreference("browser.helperApps.neverAsk.saveToDisk", "application/vnd.ms-excel, application/x-msexcel, application/pdf, application/txt, application/cfg, application/zip, text/csv,  text/plain, text/html, application/octet-stream");
            ...
            switch (BaseConfiguration.TestBrowser)
            {
                ...
                case BrowserType.Chrome:
                    ...
                    if (ConfigurationManager.AppSettings["JenkinsExecution"].Equals("true"))
                    {
                        ...
                        string driverPath = jenkinsBasePath + BaseConfiguration.LibFolder;
                        this.driver = new ChromeDriver(driverPath, this.SetDriverOptions(this.ChromeOptions));
                        break;
                    }
                    else
                    {
        ...
        /// <summary>
        /// Sends screenshot imagecontent to custom reporting steps.
        /// </summary>
        /// <returns>screenshot imagecontent</returns>

        public string SendScreenshotImageContent(string appType)
        {
            ...
            switch (appType)
            {
                ...
                case "WEB":
                    {
                        string screenshotImageContent = TakeScreenshot().ToString();
                        return screenshotImageContent;
                    }
