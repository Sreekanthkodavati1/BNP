...
{
    [TestClass]
    public class BTA500_MP_RequestCreditStore_TransactionNumber : ProjectTestBase
    {
        ...
        public void BTA_500_MP_RequestCreditStore_TransactionNumber()
        {
            ...
            try
            {
                ...
                testStep.SetOutput("LoyaltyNumber_One:" + basePages.GetLoyaltyNumber(output) + ",Name:" + output.FirstName + "Created Successfully");
                ...
                #region Step2:Login with Newely Created Member 
                ...
                #region Step4:Search With Transaction Transaction Number 
                stepName = "Search With Transaction Number: " + RequestCredit_Search_Criteria.TransactionNumber;
                testStep = TestStepHelper.StartTestStep(testStep);
                stepstatus = Mp_RequestCredit.Search_BasedOnTransactionNumber(RequestCredit_Search_Criteria.TransactionNumber, MemberPortal_RequestCredit.TransactionType.Store.ToString(), out Step_Output);
                testStep.SetOutput(Step_Output);
                testStep = TestStepHelper.EndTestStep(testCase, testStep, stepName, stepstatus, DriverContext.SendScreenshotImageContent("WEB"));
                listOfTestSteps.Add(testStep);
                #endregion
                ...
                #region Step6:Verify the Transaction in Txn_Header table
                ...
                #region Step8:Search and Verify Transaction in Sales Transactions With Specific Date Range
                stepName = "Search and Verify Transaction under Sales Transactions";
                testStep = TestStepHelper.StartTestStep(testStep);
