...
{
    [TestClass]
    public class BTA503_MP_RequestCredit_Store_TransactionDate : ProjectTestBase
    {
        ...
        public void BTA_503_MP_RequestCredit_Store_TransactionDate()
        {
            ...
            try
            {
                ...
                testStep = TestStepHelper.StartTestStep(testStep);
                stepstatus = Mp_RequestCredit.Search_BasedOnTransactionDate(RequestCredit_Search_Criteria.TransactionNumber, transactionDate, MemberPortal_RequestCredit.TransactionType.Store.ToString(), out Step_Output);
                testStep.SetOutput(Step_Output);
                testStep = TestStepHelper.EndTestStep(testCase, testStep, stepName, stepstatus, DriverContext.SendScreenshotImageContent("WEB"));
                listOfTestSteps.Add(testStep);
                #endregion
