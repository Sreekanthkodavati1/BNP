namespace BnPBaseFramework.Web
{
       ...
       public static class BaseConfiguration
    {
        ...
        ///     {
        ///     this.Driver.GetElement(this.fileLink.Format(fileName), "Click on file").ClickElement();
        ///     };
        /// </code></example>
        ...
        /// <summary>
        /// Gets the library folder key value
        /// </summary>
        public static string LibFolder
        {
            get { return ConfigurationManager.AppSettings["LibFolder"]; }
        }
