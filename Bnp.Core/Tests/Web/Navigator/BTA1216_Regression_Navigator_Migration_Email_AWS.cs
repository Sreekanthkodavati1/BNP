...
{
    /// <summary>
    /// Class to test BTA-1216  : Migration of Emails(AWS)
    /// </summary>
    [TestClass]
    public class BTA1216_Regression_Navigator_Migration_Email_AWS : ProjectTestBase
    {
        ...
        /// <summary>
        /// This method tests the Migration of Emails(AWS)
        /// </summary>
        [TestMethod]
