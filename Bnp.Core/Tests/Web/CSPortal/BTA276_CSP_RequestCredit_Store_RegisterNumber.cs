...
{
    [TestClass]
    public class BTA276_CSP_RequestCredit_Store_RegisterNumber : ProjectTestBase
    {
        ...
        public void BTA_276_CSP_RequestCredit_Store_RegisterNumber()
        {
            ...
            try
            {
                ...
                #region Step6:Search With Register Number
                stepName = "Search With Register Number:" + RequestCredit_Search_Criteria.RegisterNumber;
                testStep = TestStepHelper.StartTestStep(testStep);
                stepstatus = CSPortal_RequestCredit.Search_Store_BasedOnRegisterNumber(RequestCredit_Search_Criteria.TransactionNumber, RequestCredit_Search_Criteria.RegisterNumber, out Step_Output);
                testStep.SetOutput(Step_Output);
                testStep = TestStepHelper.EndTestStep(testCase, testStep, stepName, stepstatus, DriverContext.SendScreenshotImageContent("WEB"));
                listOfTestSteps.Add(testStep);
                #endregion
