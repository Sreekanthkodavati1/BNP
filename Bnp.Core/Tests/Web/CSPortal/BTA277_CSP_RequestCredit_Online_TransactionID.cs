...
{
    [TestClass]
    public class BTA277_CSP_RequestCredit_Online_TransactionID : ProjectTestBase
    {
        ...
        public void BTA_277_CSP_RequestCredit_Online_TransactionID()
        {
            ...
            try
            {
                ...
                #region Step6:Search With Transaction Number
                stepName = "Select Online and Search With Transaction Number:"+ RequestCredit_Search_Criteria.TransactionNumber;
                testStep = TestStepHelper.StartTestStep(testStep);
                CSPortal_RequestCredit.Select_Online();
                stepstatus = CSPortal_RequestCredit.Search_Online_BasedTransactionNumber(RequestCredit_Search_Criteria.TransactionNumber, out Step_Output);
                testStep.SetOutput(Step_Output);
                testStep = TestStepHelper.EndTestStep(testCase, testStep, stepName, stepstatus, DriverContext.SendScreenshotImageContent("WEB"));
