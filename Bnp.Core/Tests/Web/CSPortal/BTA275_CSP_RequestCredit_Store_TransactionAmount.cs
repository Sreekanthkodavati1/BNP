...
{
    [TestClass]
    public class BTA275_CSP_RequestCredit_Store_TransactionAmount : ProjectTestBase
    {
        ...
        public void BTA_275_CSP_RequestCredit_Store_TransactionAmount()
        {
            ...
            try
            {
                ...
                testStep = TestStepHelper.StartTestStep(testStep);
                stepstatus = CSPortal_RequestCredit.Search_Store_BasedOnTransactionAmount(RequestCredit_Search_Criteria.TransactionNumber, RequestCredit_Search_Criteria.TxnAmount, out Step_Output);
                testStep.SetOutput(Step_Output);
                testStep = TestStepHelper.EndTestStep(testCase, testStep, stepName, stepstatus, DriverContext.SendScreenshotImageContent("WEB"));
                listOfTestSteps.Add(testStep);
                #endregion
