namespace BnPBaseFramework.Web.Extensions
{
    ...
    public static class WebDriverExtensions
    {
        ...
        /// The <see cref="bool" />.
        /// </returns>
        public static bool IsElementNotPresent(this IWebDriver webDriver, ElementLocator locator, double customTimeout)
        {
            try
            {
                webDriver.GetElement(locator, customTimeout, e => e.Displayed);
            ...
            {
                throw new Exception("Element is not available:" + locator);
        ...
        /// <summary>
        /// Verify for the presence of the element
        /// /// </summary>
        /// <example>Example code to wait for login Button: <code>
        /// this.Driver.IsElementPresent(by);
        /// </code></example>
        /// <param name="webDriver">The web driver.</param>
        ...
        /// this.Driver.Actions().SendText(Keys.Return).Perform();
        /// </code></example>
        /// <param name="webDriver">The web driver.</param>
